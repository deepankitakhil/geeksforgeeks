 ...
 */
public class IterativeLongestCommonPalindromeSubSequence {
  public static void main(String[] args) {
    IterativeLongestCommonPalindromeSubSequence iterativeLongestCommonPalindromeSubSequence = new IterativeLongestCommonPalindromeSubSequence();
    int longestCommonPalindromeLength = iterativeLongestCommonPalindromeSubSequence.longestCommonPalindromeMethodOne("BBABCBCAB");
    System.out.println(longestCommonPalindromeLength);
  }
